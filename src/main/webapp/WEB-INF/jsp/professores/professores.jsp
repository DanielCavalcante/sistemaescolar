...
<div class="form-group">
	...
	<label class="col-sm-2 control-label"><fmt:message key="professor.nacionalidade" /></label>
   	<div class="col-sm-3">
		<select name="professor.nacionalidade" id="nacionalidade" class="form-control">
			<option value=""><fmt:message key="menu.selecione" /></option>
...
<div class="form-group" id="estadoCidade">
	<label class="col-sm-2 control-label"><fmt:message key="professor.ufnascimento" /></label>
	<div class="col-sm-3">
		<select id="estadoSelect" name="professor.estadoNascimento.id" class="form-control">
			<option value=""><fmt:message key="menu.selecione" /></option>
